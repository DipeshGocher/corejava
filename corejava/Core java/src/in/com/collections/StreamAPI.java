...
public class StreamAPI {
	...
	//	for start with S letter
		
		List<String> name = List.of("hardeep", "dipesh", "shubham", "shweta","swati","sourabh");
...
//	      
	...
	//	for clear the double values
	      
//	      List<Integer> list4 = List.of(1,1,2,3,3,5,6,6,8,8,4,3,6,7);
//	      
